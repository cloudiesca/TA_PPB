...
//         // FIXED: Pass correct product data with image
//         const productToAdd = {
//             ...product,
...
//     return (
//         <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 pb-20 md:pb-8 pt-20">
//             {/* Header */}
//             <div className="sticky top-16 z-10 bg-white/80 backdrop-blur-md border-b border-slate-200 shadow-sm">
...
//                     {/* Product Image - FIXED */}
//                     <div className="bg-white rounded-2xl overflow-hidden shadow-lg md:sticky md:top-32 h-fit">
//                         <img
//                             src={getImageUrl()}
//                             alt={product.name}
...
//                                 {product.name}
//                             </h1>
//                             <p className="text-slate-600">{product.brands?.name || 'Brand'} • {product.categories?.name || 'Kategori'}</p>
//                         </div>
...
// src/pages/ProductDetailPage.jsx - FIXED VERSION
